...
function httpGetAsync3(theUrl, callback)
{
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.onreadystatechange = function() { 
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
        ...
        if ($("#lineChart").length) {
            ...
            globalLineChart1 = new Chart(f, {
                ...
                options: {
                    ...
                    title: {
                      display: true,
                      text: 'MMMP Network BW Line Chart'
                    },
                    tooltips: {
                      mode: 'index',
                      intersect: false,
...
$.fn.popover.Constructor.prototype.leave = function(a) {
   ...
   /* junhee code */, setInterval(function() {
	   	httpGetAsync2('./jsp/bw1.jsp', myCallBack2);
 	}, 1000), setInterval(function() {
	   	httpGetAsync3('./jsp/bw1.jsp', myCallBack3);
 	}, 1000);
});
