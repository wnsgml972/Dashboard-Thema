...
function init_interface_name5(response){ //gre
  response = eraseUnUse(response);
  response = replaceAll(response, "@enp0s8", "");
...
if(window.location.href.includes("index.html")){
  $(document).ready(function() {
    ...
    }, 1000), interval_interface_id2 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName2, myCallBack3);
    }, 1000), interval_interface_id3 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName3, myCallBack4);
    }, 1000), interval_interface_id4 = setInterval(function() {
...
if(window.location.href.includes("index3.html")){
 $(document).ready(function() {
    httpGetAsync('./jsp/get_hostip.jsp', init_video_source1), httpGetAsync('./jsp/get_hostip.jsp', init_video_source1),
...
if(!window.location.href.includes("index3.html")){
  $(document).ready(function() {
    clearInterval(interval_interface_id5), clearInterval(interval_interface_id6), clearInterval(interval_interface_id1);
  });
}
